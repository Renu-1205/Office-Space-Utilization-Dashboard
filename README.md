...
**Solution:**  
Developed an interactive Power BI dashboard to track and analyze workspace utilization across:
- Space types
- Departments
- Time patterns

**Impact:**  
Identified opportunities to reduce real estate costs by **15–25%** through data-driven space optimization.
...
|------------|----------------|-------------------|
| Private Office | ~100% | High (~100) |
| Collaboration | ~75–80% | Low (~15) |
| Meeting Room | ~75–80% | Moderate (~18–20) |
...
|------------|-------------|
| Engineering, Marketing | ~100% (High) |
...
- Optimize for peak-hour demand
- Adopt hybrid work models
- Reduce investment in low-efficiency space types
...
| File | Description |
|------|-------------|
| `Office_space.pbix` | Power BI Dashboard |
| `office_clean.xlsx` | Cleaned Dataset |
...
🔗 **LinkedIn:** [https://www.linkedin.com/in/renusaharan2003/](https://www.linkedin.com/in/renusaharan2003/)  
📧 **Email:** renu@students.sau.ac.in
...
3. Use insights for space planning decisions
